...
AuthservicioService.ctorParameters = () => [
...
let DetallevehiculoComponent = class DetallevehiculoComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let FormMostrarComponent = class FormMostrarComponent {
...
FormMostrarComponent.ctorParameters = () => [
...
//import { Tipo } from '../modelos/tipo';
let FormcargaVehiculoComponent = class FormcargaVehiculoComponent {
    constructor(http, as, ta, router) {
...
FormcargaVehiculoComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
let FormfiltrarComponent = class FormfiltrarComponent {
    // tipos = new Array<string>();
    //listaFiltradoTipo:Array<auto>;
    //selectedValue = "vacio";
    //selectedValue = Tipo.vacio;
...
FormfiltrarComponent.ctorParameters = () => [
...
let FormularioComponent = class FormularioComponent {
     ...
     */
    constructor(_concesServ, router) {
...
let LoginComponent = class LoginComponent {
    constructor(ls, router, concesionaria) {
        this.ls = ls;
        this.router = router;
...
class auto {
    ...
    constructor(_marca, _modelo, _an, _kilometros, _tipo, _foto, _localidad, _concesionaria) {
        this.marca = _marca;
        this.modelo = _modelo;
        this.an = _an;
...
class Concesionaria {
    constructor(_user, _pass, _email, razon_social, _telefono, _localidad) {
        this.user = _user;
        this.pass = _pass;
        this.email = _email;
...
class vehiculo {
    constructor(marca, modelo, an, kilometros, tipo, foto) {
        this.marca = marca;
        this.modelo = modelo;
        this.an = an;
...
let ConcesionariaService = class ConcesionariaService {
    constructor(http) {
        this.http = http;
    ...
    getConcesionaria(_cli) {
        return this.http.get(this.urllogin);
    }
};
ConcesionariaService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let TraerautosService = class TraerautosService {
    constructor(http, auth) {
        this.http = http;
        this.auth = auth;
...
TraerautosService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: _auth_authservicio_service__WEBPACK_IMPORTED_MODULE_3__["AuthservicioService"] }
];
